    ...
    <nav class="border-b border-gray-200 bg-white dark:border-white/10 dark:bg-gray-900" x-data="{ mobileOpen: false }">
            ...
            <div class="flex h-16 justify-between">
                <div class="flex">
                    <div class="hidden sm:-my-px sm:ml-6 sm:flex sm:space-x-8">
                        ...
                        <a href="#" aria-current="{{ request()->is('duties*') ? 'page' : '' }}" class="{{ request()->is('duties*') ? 'inline-flex items-center border-b-2 border-indigo-600 px-1 pt-1 text-sm font-medium text-gray-900 dark:border-indigo-500 dark:text-white' : 'inline-flex items-center border-b-2 border-transparent px-1 pt-1 text-sm font-medium text-gray-500 hover:border-gray-300 hover:text-gray-700 dark:text-gray-400 dark:hover:border-white/20 dark:hover:text-gray-200' }}">Duties</a>
                    </div>
                </div>
        ...
        <div x-show="mobileOpen" class="block sm:hidden">
            <div class="space-y-1 pt-2 pb-3">
                ...
                <a href="#" aria-current="{{ request()->is('duties*') ? 'page' : '' }}" class="{{ request()->is('duties*') ? 'block border-l-4 border-indigo-600 bg-indigo-50 py-2 pr-4 pl-3 text-base font-medium text-indigo-700 dark:border-indigo-500 dark:bg-indigo-600/10 dark:text-indigo-300' : 'block border-l-4 border-transparent py-2 pr-4 pl-3 text-base font-medium text-gray-600 hover:border-gray-300 hover:bg-gray-50 hover:text-gray-800 dark:text-gray-400 dark:hover:border-gray-500 dark:hover:bg-white/5 dark:hover:text-gray-200' }}">Duties</a>
            </div>
